...
void loop()
{
  ...
  if (flag)
  {
    Serial.print(Prev_1->x);
    Serial.print(" ");
    Serial.print(Prev_1->y);
    Serial.print(" ");
    Serial.print(Prev_2->x);
    Serial.print(" ");
    Serial.print(Prev_2->y);
    Serial.print(" ");
    Serial.print(Prev_3->x);
    Serial.print(" ");
    Serial.print(Prev_3->y);
    Serial.print(" ");
    Serial.print(Prev_4->x);
    Serial.print(" ");
    Serial.println(Prev_4->y);
